...
class InitTestDb extends AbstractMigration
{
    /**
     * Migrate Up.
     */
    public function up()
    {
        $this->execute( file_get_contents( __DIR__ . '/../../../../main/resources/up.sql' ) );
    }
    ...
    {
        $this->execute( file_get_contents( __DIR__ . '/../../../../main/resources/down.sql' ) );
    }
}
