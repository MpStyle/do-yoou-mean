...
namespace mpstyle\doyoumean\repository\factory;

use mpstyle\doyoumean\repository\mysql\MySQLRepositoryContainer;
...
class MySQLRepositoryFactory implements RepositoryFactory
{
    ...
    {
        $this->repositoryContainer = new MySQLRepositoryContainer( $connection );
    }
