...
/**
 * Class NoAlternativeWord is used when there aren't any word to suggest.
 *
 * @package mpstyle\doyoumean\entity
 */
class NoAlternativeWord extends AlternativeWord
{
    public function __construct($language)
    {
        parent::__construct($language, null, null);
    }
}