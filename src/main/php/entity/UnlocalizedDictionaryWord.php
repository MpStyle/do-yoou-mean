...
class UnlocalizedDictionaryWord extends DictionaryWord
{
    const LANGUAGE = 'doyoumean';

    public function __construct($word=null)
    {
        parent::__construct(self::LANGUAGE, $word);
    }
    ...
    {
        throw new \Exception( 'The "language" property is read-only.' );
    }
